...
public class Question {
	...
	public Question(int id, String category, String diffcultyLevel, String questionTitle, String option1,
	...
	public String toString() {
		return "Question [id=" + id + ", category=" + category + ", diffcultyLevel=" + diffcultyLevel
